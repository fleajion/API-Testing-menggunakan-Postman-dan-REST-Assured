package com.pratikum.rest.runners;
 ...
 * Berguna untuk custom test execution atau integration dengan
 * CI/CD
 */
public class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        testng.setTestClasses(new Class[] {
                com.pratikum.rest.tests.UserAPITests.class,
                com.pratikum.rest.tests.AuthenticationTests.class,
                com.pratikum.rest.tests.AdvancedAPITests.class,
                com.pratikum.rest.tests.FakerDataTests.class
        });
