package com.pratikum.rest.config;

/**
 * Configuration class untuk menyimpan semua constants dan
...
public class TestConfig {
    ...
    public static final String REQRES_BASE_URL =
            "https://reqres.in/api";
    ...
    // Test data constants untuk data yang konsisten
    ...
    public static final String USERS_SCHEMA_PATH =
            "schemas/users-schema.json";
    public static final String USER_SCHEMA_PATH =
            "schemas/user-schema.json";
    public static final String LOGIN_SCHEMA_PATH =
