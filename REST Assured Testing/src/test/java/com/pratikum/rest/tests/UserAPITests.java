...
public class UserAPITests {
     ...
     * Menastikan menggunakan JSONPlaceholder API untuk consistency
     */
    @BeforeMethod
    public void setupMethod() {
        // Set base URL untuk JSONPlaceholder API
        RestAssured.baseURI = "https://jsonplaceholder.typicode.com";
    }

    // Semua test method tetap sama seperti sebelumnya...
    /**
    ...
    public void testGetUserById() {
        given()
                ...
                .body("name", equalTo("Leanne Graham")) // Validate name user
    ...
    public void testGetUserNotFound() {
        given()
                .contentType(ContentType.JSON)
                .pathParam("id", 999) // Use nonexistent user ID
                .when()
    ...
    public void testCreateUser() {
        ...
        given()
                ...
                .contentType(ContentType.JSON) // Validate content type
                .body("name", equalTo("John Doe")) // Validate name dalam response
    ...
    public void testUpdateUser() {
        ...
        given()
                ...
                .contentType(ContentType.JSON) // Validate content type
                .body("name", equalTo("John Updated")) // Validate name terupdate
